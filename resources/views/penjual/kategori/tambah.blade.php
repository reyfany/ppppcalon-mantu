                    ...
                    <div class="row ">
                            <div class="col-md-12 ">
                                <div class="form-group ">
                                    ...
                                    <input type="text " class="form-control " placeholder="Nama Kategori * " name="nama_kategori" value="{{ old('nama_kategori') }}" required=" " />
                                </div>
                            </div>
                            <div class="col-md-12 ">
                                <div class="form-group ">
                                    <label class="form-label "><b>Slug Kategori</b></label>
                                    <input type="text " class="form-control " placeholder="Slug Kategori * " name="slug_kategori"  value="{{ old('slug_kategori') }}" required=" " />
                                </div>
                            </div>
                            <div class="col-md-12 ">
                                <div class="form-group ">
                                    <label class="form-label "><b>Deskripsi</b></label>
                                    <input type="text " class="form-control " placeholder="Deskripsi * " name="deskripsi" value="{{ old('deskripsi') }}"  required=" " />
                                </div>
                            </div>
                            <div class="col-md-12 ">
                            <div class="form-group">
